  ...
  return (
    <>
      ...
      <nav className={navScrolled ? 'scrolled' : ''}>
        <div className="nav-logo">JD<span>S</span>.dev</div>
      ...
      <section id="pitch">
        <div className="section-header fade-up">
          <div>
            ...
            <h2 className="section-title">Crezcamos <span style={{color:'var(--accent)'}}>tu marca</span></h2>
          </div>
        ...
        <div className="funnel-grid fade-up">
          ...
          <div>
            ...
            <div className="funnel-btns">
              <a
                href="https://wa.me/1234567890?text=Hola%2C%20quiero%20hablar%20sobre%20un%20proyecto"
